...
#else
#define MAX_MMAP_REGIONS		(11 + 3)
#define MAX_XLAT_TABLES			(11 + 3)
#endif
 ...
 * we have 2TB of physical address space to cover.  Since the GPT size can be
...
/* Reserved some DRAM space for RMM (28MB) */
